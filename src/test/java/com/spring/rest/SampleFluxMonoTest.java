...
public class SampleFluxMonoTest {
  ...
  void fluxStringConcatMapAsync() {
    ...
    StepVerifier.create(fluxString_concatMap_async).expectNextCount(6).verifyComplete();
  }

  @Test
  void fluxStringTransform() {
    var fluxString_transform = sampleFluxMono.fluxString_transform(6);
    StepVerifier.create(fluxString_transform).expectNext("DEFAULT").verifyComplete();
  }
  ...
  void fluxStringMerge() {
    ...
    StepVerifier.create(string_merge)
        .expectNext("Name 1", "Name 3", "Name 2", "Name 4")
        .verifyComplete();
  }
  ...
  void fluxStringMergeSequential() {
    ...
    StepVerifier.create(fluxString_mergeSequential)
        .expectNext("Name 1", "Name 2", "Name 3", "Name 4")
        .verifyComplete();
  }
  ...
  void fluxStringZipWith() {
    ...
    StepVerifier.create(fluxString_zipWith)
        .expectNext("Name 1Name 3", "Name 2Name 4")
        .verifyComplete();
  }
